...
margin-right: auto; background-color:rgba(224, 122, 26, 0.664); opacity:0.4;">
    <tr>
        ...
        <th scope="col" style="padding: 4px;  border: 1px solid rgb(221, 84, 5);">Tipo de Alimento</th>
    </tr>
    @foreach($consultaAlimentos as $alimento)
        <tr>
            <td scope="row" style="padding: 4px;  border: 1px solid rgb(221, 84, 5);">{{$alimento->id}}</td>
            <td style="padding: 4px;  border: 1px solid rgb(221, 84, 5);">{{$alimento->descripcion}}</td>
            <td style="padding: 4px;  border: 1px solid rgb(221, 84, 5);">{{$alimento->precioVenta}}</td>
            <td style="padding: 4px;  border: 1px solid rgb(221, 84, 5);">{{$alimento->tipoAlimento}}</td>
        </tr>
    @endforeach
