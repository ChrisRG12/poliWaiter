                ...
                <form action="{{ route('ingredientes.update', $consultaIngredientes->id) }}" method="post">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="Nombre" name="descripcion"
                            ...
                            placeholder="" value="{{$consultaIngredientes->descripcion}}" required>
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="text" id="precioVenta" name="precioVenta"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="" value="{{$consultaIngredientes->precioVenta}}" required>
                    </div>
                    ...
                    @if($consultaIngredientes->ingredienteExtra == 1)
                    <div class="mb-6">
                        <div class="flex items-center mb-4">
                            <input type="hidden" name="ingredienteExtra" value="0"/>

                            <input checked  id="checkbox-1" type="checkbox" name="ingredienteExtra" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" >
                            <label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ingrediente Extra</label>
                        </div>
                    </div>
                    @endif
                    ...
                    @endif
                    @if($consultaIngredientes->disponibilidad == 1)
                    <div class="mb-6">
                        <div class="flex items-center mb-4">
                            <input type="hidden" name="disponible" value="0"/>

                            <input checked id="checkbox-1" type="checkbox" name="disponible" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" >
                            <label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Disponible</label>
                        </div>
                    </div>
                    @endif
